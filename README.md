...
[Version 0.7.1](https://github.com/SummitPublicSchools/calpads/tree/0.7.1) is pretty great and covers many use-cases. Given its lack of official support, the wrapper is subject to break at any moment if the internals of CALPADS magic change.
